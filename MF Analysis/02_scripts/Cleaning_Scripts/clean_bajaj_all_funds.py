...
OUTPUT_FOLDER = PROJECT_ROOT / "03_clean_data" / "BAJAJ_FINSERV"
OUTPUT_FOLDER.mkdir(parents=True, exist_ok=True)
OUTPUT_FILE = OUTPUT_FOLDER / "Bajaj_Finserv_All_Funds_Cleaned.xlsx"

AMC_NAME = "BAJAJ Finserv MF"
...
TARGET_FUNDS_CONFIG = {
    ...
    "BFELSS": "Bajaj Finserv ELSS Tax Saver Fund",
    "BFEQSF": "Bajaj Finserv Equity Savings Fund",
    "BFFLX": "Bajaj Finserv Flexi Cap Fund",
    "BFFLXF": "Bajaj Finserv Flexi Cap Fund",
    "BFHCARE": "Bajaj Finserv Healthcare Fund",
    "BFLARGE": "Bajaj Finserv Large Cap Fund",
}
...
def clean_bajaj_data():
    print("=" * 70)
    print("BAJAJ FINSERV MUTUAL FUND - CLEANING PIPELINE")
    ...
    for fpath in excel_files:
        ...
        for code, canonical_name in TARGET_FUNDS_CONFIG.items():
            ...
            for r_idx, r_vals in enumerate(rows_data[:10]):
